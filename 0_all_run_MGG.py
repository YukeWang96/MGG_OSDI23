...
#     os.system("./0_bench.py {0}| tee MGG_Dist_{0}.log".format(dist))
#     os.system("./1_analysis.py MGG_Dist_{0}.log {1}".format(dist, 4))
#     os.system("mv MGG_Dist_{0}.log logs/".format(dist))

for dist in [1,2,4,8,16,32]:
    os.system("./0_bench.py {0}| tee MGG_wpb_{0}.log".format(dist))
    os.system("./1_analysis.py MGG_wpb_{0}.log {1}".format(dist, 4))
    os.system("mv MGG_wpb_{0}.log logs/".format(dist))