...
os.system("./extract_search_dist_ps.py 6 > Reddit_4xA100_dist_ps.csv")
# os.system("mv MGG_dist_*_ps*.csv csvs/")
...
os.system("./extract_search_dist_wpb.py 5 > Reddit_4xA100_dist_wpb.csv")
# os.system("mv MGG_dist_*_wpb*.csv csvs/")
