...
with open('MGG_WO_NP.csv', 'r') as file1:
...
with open('MGG_NP.csv', 'r') as file2:
...
with open('MGG_NP_study.csv', 'w', newline='') as result_file:
...
os.system("mv MGG_NP.csv csvs/")
os.system("mv MGG_WO_NP.csv csvs/")