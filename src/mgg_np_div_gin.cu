...
int main(int argc, char* argv[]){
    ...
    gpuErrchk(cudaMalloc((void**)&dsp_out_1, nodesPerPE * hiddenSize * sizeof(float))); 
    gpuErrchk(cudaMalloc((void**)&dsp_out_2, nodesPerPE * hiddenSize * sizeof(float))); 
    gpuErrchk(cudaMalloc((void**)&dsp_out_3, nodesPerPE * hiddenSize * sizeof(float))); 
    gpuErrchk(cudaMalloc((void**)&dsp_out_4, nodesPerPE * hiddenSize * sizeof(float))); 
    ...
    // gpuErrchk(cudaMemcpy(dsp_out_1, hsp_output_1, nodesPerPE * hiddenSize * sizeof(float), cudaMemcpyHostToDevice));
    // gpuErrchk(cudaMemcpy(dsp_out_2, hsp_output_2, nodesPerPE * hiddenSize * sizeof(float), cudaMemcpyHostToDevice));
    // gpuErrchk(cudaMemcpy(dsp_out_3, hsp_output_3, nodesPerPE * hiddenSize * sizeof(float), cudaMemcpyHostToDevice));
    // gpuErrchk(cudaMemcpy(dsp_out_4, hsp_output_4, nodesPerPE * outdim * sizeof(float), cudaMemcpyHostToDevice));

    dense_param_beg* dp1 = new dense_param_beg("d-1", d_input, nodesPerPE, dim, hiddenSize);
    dense_param_hidden* dp2 = new dense_param_hidden("d-2", dsp_out, nodesPerPE, hiddenSize, hiddenSize);
    dense_param_hidden* dp3 = new dense_param_hidden("d-3", dsp_out_1, nodesPerPE, hiddenSize, hiddenSize);
    dense_param_hidden* dp4 = new dense_param_hidden("d-4", dsp_out_2, nodesPerPE, hiddenSize, hiddenSize);
    dense_param_hidden* dp5 = new dense_param_hidden("d-5", dsp_out_3, nodesPerPE, hiddenSize, hiddenSize);
    dense_param_hidden* dp6 = new dense_param_hidden("d-6", dsp_out_4, nodesPerPE, hiddenSize, outdim);
    softmax_param* smx2 = new softmax_param("smx-2", dp6->d_out, nodesPerPE, outdim);
