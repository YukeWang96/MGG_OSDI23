...
int main(int argc, char* argv[]){
    ...
    float *d_input, *dsp_out, *h_input, *h_output;
    ...
    for (int i = 0; i < num_profiles; i++)
    {
        ...
        mgg_SAG_np_div_wo_np(dsp_out, dp1->d_out, d_row_ptr_l, d_col_ind_l, d_row_ptr_r, d_col_ind_r,
                            lb, ub, hiddenSize, nodesPerPE, mype_node);
    }
