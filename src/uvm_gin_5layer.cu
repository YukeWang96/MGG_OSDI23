...
int main(int argc, char* argv[]){
    ...
    float **d_input, **d_den_out_1, **d_den_out_2, **d_den_out_3, **d_den_out_4, **d_den_out_5, **d_den_out_6;
...
for (int mype_node = 0; mype_node < num_GPUs; mype_node++)
{
    ...
    float * dsp_out, *dsp_out_1, *dsp_out_2, *dsp_out_3, *dsp_out_4;
    ...
    dense_param_hidden_uvm* dp2 = new dense_param_hidden_uvm("d-2", dsp_out, mype_node, d_den_out_2, nodesPerPE, hiddenSize, hiddenSize);
    dense_param_hidden_uvm* dp3 = new dense_param_hidden_uvm("d-3", dsp_out_1, mype_node, d_den_out_3, nodesPerPE, hiddenSize, hiddenSize);
    dense_param_hidden_uvm* dp4 = new dense_param_hidden_uvm("d-4", dsp_out_2, mype_node, d_den_out_4, nodesPerPE, hiddenSize, hiddenSize);
    dense_param_hidden_uvm* dp5 = new dense_param_hidden_uvm("d-5", dsp_out_3, mype_node, d_den_out_5, nodesPerPE, hiddenSize, hiddenSize);
    dense_param_hidden_uvm* dp6 = new dense_param_hidden_uvm("d-6", dsp_out_4, mype_node, d_den_out_6, nodesPerPE, hiddenSize, outdim);
    softmax_param* smx2 = new softmax_param("smx-2", d_den_out_6[mype_node], nodesPerPE, outdim);
