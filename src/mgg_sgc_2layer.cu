...
int main(int argc, char* argv[]){
    ...
    // define SGC model
    // 
    SGC_param_beg* sp1 = new SGC_param_beg("s-1", d_row_ptr, d_col_ind, numNodes, dim, khop);
    dense_param_hidden* dp1 = new dense_param_hidden("d-1", sp1->d_out, numNodes, dim, dim1);
    SGC_param_hidden* sp2 = new SGC_param_hidden("s-2",  dp1->d_out, d_row_ptr, d_col_ind, numNodes, dim1, khop);
