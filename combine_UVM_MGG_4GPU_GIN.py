...
with open('MGG_4GPU_GIN.csv', 'r') as file1:
    reader = csv.reader(file1)
    col0 = [row[0] for row in reader]

with open('UVM_GIN_4GPU.csv', 'r') as file1:
    reader = csv.reader(file1)
...
with open('MGG_4GPU_GIN.csv', 'r') as file2:
...
with open('Fig_8_UVM_MGG_4GPU_GIN.csv', 'w', newline='') as result_file:
...
# os.system("mv UVM_4GPU_GIN.csv csvs/")
os.system("mv MGG_4GPU_GIN.csv csvs/")
os.system("mv *.err logs/")

print("\n\nCheck [Fig_8_UVM_MGG_4GPU_GIN.csv] for results!!\n\n")