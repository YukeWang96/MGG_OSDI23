...
for dist in [1,2,4,8,16]:
    for ps in [1,2,4,8,16,32]:
        os.system("./bench_MGG_DSE_dist_ps.py {0} {1}| tee MGG_dist_{0}_ps_{1}.log".format(dist, ps))
...
os.system("./extract_search.py 6 > Reddit_8xA100_dist_ps.csv")

for dist in [1,2,4,8,16]:
    for wpb in [1,2,4,8,16]:
        os.system("./bench_MGG_DSE_dist_wpb.py {0} {1}| tee MGG_dist_{0}_wpb_{1}.log".format(dist, wpb))
...
os.system("./extract_search.py 5 > Reddit_8xA100_dist_wpb.csv")